...
export default function Home() {
  ...
  return <main>
    ...
    <footer className="footer shell"><a className="brand" href="#top"><span className="brandMark">R0</span><span>ReproZero</span></a><p>Production evidence -&gt; executable certainty.</p><span>Fast Hackathon / 2026</span></footer>
  </main>;
}
